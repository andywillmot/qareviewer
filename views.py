...
class ReviewIterationExport(generic.View):

    def get(self, *args, **kwargs ):
        dataset = ReviewIterationResource().export()
        response = HttpResponse(dataset.csv, content_type="csv")
        response['Content-Disposition'] = 'attachment; filename=filename.csv'
        return response


class ReviewIterationImport(generic.View):
    model = ReviewIteration
    from_encoding = "utf-8"
...
class ReviewIterationProcessImport(generic.View):
    model = ReviewIteration
    from_encoding = "utf-8"
...
class CommentExport(generic.View):
...
class CommentImport(generic.View):
    model = Comment
    from_encoding = "utf-8"
...
class CommentProcessImport(generic.View):
    model = Comment
    from_encoding = "utf-8"
